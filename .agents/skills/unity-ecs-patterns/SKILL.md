...
- **Batch structural changes** - Use `ECB` (EntityCommandBuffer)
- **Profile with Profiler** - Identify bottlenecks
- **Use Aspects** - Clean component grouping

### Don't's
- **Don't use managed types** - Breaks Burst compilation
- **Don't make structural changes in jobs** - Use `ECB` instead
- **Don't over-architect** - Start simple
- **Don't ignore chunk utilization** - Group similar entities
- **Don't forget disposal** - Native collections will leak memory if not disposed
